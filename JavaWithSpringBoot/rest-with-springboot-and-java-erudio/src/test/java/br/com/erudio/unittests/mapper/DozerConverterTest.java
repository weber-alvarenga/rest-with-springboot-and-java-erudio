...
public class DozerConverterTest {
    ...
    public void parseEntityListToVOListTest() {
        List<PersonVO> outputList = DozerMapper.parseObjectsList(inputObject.mockEntityList(), PersonVO.class);
    ...
    public void parserVOListToEntityListTest() {
        List<Person> outputList = DozerMapper.parseObjectsList(inputObject.mockVOList(), Person.class);
